...
public class MeController {
    ...
    public ResponseEntity<?> update(
        ...
        try {
            ...
            if (req.interests() != null) u.setInterests(om.writeValueAsString(req.interests()));
            if (req.links() != null) u.setLinks(om.writeValueAsString(req.links()));
    ...
    private UserDTO toDTO(User u) throws Exception {
        ...
        return new UserDTO(
                u.getId(), u.getEmailInst(), u.getNombre(), u.isActive(),
                u.getBio(), interests, links, u.getAvatarUrl(), u.getCoverUrl(), roles
        );
    }
}
